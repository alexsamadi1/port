...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#0f0f0f] via-[#1a1f33] to-[#050505] text-white overflow-hidden">
      ...
      {/* Footer */}
      <footer className="w-full px-6 sm:px-12 lg:px-24 pt-10 pb-12 border-t border-white/10 text-center space-y-3 text-gray-400 text-sm">
